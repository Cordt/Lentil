...
public final class DefaultProfileQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct DefaultProfile: GraphQLSelectionSet {
      ...
      public init(id: String, name: String? = nil, bio: String? = nil, isDefault: Bool, attributes: [Attribute]? = nil, followNftAddress: String? = nil, metadata: String? = nil, handle: String, picture: Picture? = nil, coverPicture: CoverPicture? = nil, ownedBy: String, dispatcher: Dispatcher? = nil, stats: Stat, followModule: FollowModule? = nil) {
        self.init(unsafeResultMap: ["__typename": "Profile", "id": id, "name": name, "bio": bio, "isDefault": isDefault, "attributes": attributes.flatMap { (value: [Attribute]) -> [ResultMap] in value.map { (value: Attribute) -> ResultMap in value.resultMap } }, "followNftAddress": followNftAddress, "metadata": metadata, "handle": handle, "picture": picture.flatMap { (value: Picture) -> ResultMap in value.resultMap }, "coverPicture": coverPicture.flatMap { (value: CoverPicture) -> ResultMap in value.resultMap }, "ownedBy": ownedBy, "dispatcher": dispatcher.flatMap { (value: Dispatcher) -> ResultMap in value.resultMap }, "stats": stats.resultMap, "followModule": followModule.flatMap { (value: FollowModule) -> ResultMap in value.resultMap }])
      }
      ...
      public struct Picture: GraphQLSelectionSet {
        ...
        public static func makeNftImage(contractAddress: String, tokenId: String, uri: String, chainId: Int, verified: Bool) -> Picture {
          return Picture(unsafeResultMap: ["__typename": "NftImage", "contractAddress": contractAddress, "tokenId": tokenId, "uri": uri, "chainId": chainId, "verified": verified])
        }
        ...
        public struct AsNftImage: GraphQLSelectionSet {
          ...
          public static var selections: [GraphQLSelection] {
            return [
              ...
              GraphQLField("chainId", type: .nonNull(.scalar(Int.self))),
          ...
          public init(contractAddress: String, tokenId: String, uri: String, chainId: Int, verified: Bool) {
            self.init(unsafeResultMap: ["__typename": "NftImage", "contractAddress": contractAddress, "tokenId": tokenId, "uri": uri, "chainId": chainId, "verified": verified])
          }
          ...
          public var chainId: Int {
            get {
              return resultMap["chainId"]! as! Int
            }
            set {
      ...
      public struct CoverPicture: GraphQLSelectionSet {
        ...
        public static func makeNftImage(contractAddress: String, tokenId: String, uri: String, chainId: Int, verified: Bool) -> CoverPicture {
          return CoverPicture(unsafeResultMap: ["__typename": "NftImage", "contractAddress": contractAddress, "tokenId": tokenId, "uri": uri, "chainId": chainId, "verified": verified])
        }
      ...
      public struct FollowModule: GraphQLSelectionSet {
        ...
        public static func makeFeeFollowModuleSettings(type: FollowModules, contractAddress: String, amount: AsFeeFollowModuleSettings.Amount, recipient: String) -> FollowModule {
          return FollowModule(unsafeResultMap: ["__typename": "FeeFollowModuleSettings", "type": type, "contractAddress": contractAddress, "amount": amount.resultMap, "recipient": recipient])
        }
