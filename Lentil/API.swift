...
public struct NewFollowerNotificationFields: GraphQLFragment {
  ...
  public struct Wallet: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
        GraphQLFragmentSpread(UserWallet.self),
      ]
    }
    ...
    public struct Fragments {
      ...
      public var userWallet: UserWallet {
        get {
          return UserWallet(unsafeResultMap: resultMap)
        }
        set {
          resultMap += newValue.resultMap
        }
...
public struct UserWallet: GraphQLFragment {
  /// The raw GraphQL definition of this fragment.
  public static let fragmentDefinition: String =
    """
